...
# méthodes supplémentaires implémantés
...
#Ceci est la partie ajoutée :
    ...
    def retrait_bibliotecaire(self,numero):
        ...
        for j in range(len(self.__bibliothecaires)):
            if self.__bibliothecaires[j]==x:
                self.__bibliotecaires=self.__bibliothecaires[:j-1]+self.__bibliothecaires[j+1:]
...
#bibliothécaire sans s à corriger dans le UML 
...
#Ceci est la partie concernant la classe Emprunt :
...
# La classe Emprunt représente un emprunt de livre fait par un lecteur sous la supervision d'un bibliothécaire.
class Emprunt:
...
#Ceci est la partie concernant le conservateur 
...
from lecteur import *
from livre import *
from emprunt import Emprunt  # Importation de la classe Emprunt
